...
call validate   ..\ubl\xsd\maindoc\UBL-DocumentStatus-2.3.xsd extended DocumentStatus InvoiceDocumentStatus-test-bad-data-1.xml
call validate   ..\ubl\xsd\maindoc\UBL-DocumentStatus-2.3.xsd extended DocumentStatus InvoiceDocumentStatus-test-bad-data-2.xml
call validate   ..\ubl\xsd\maindoc\UBL-DocumentStatus-2.3.xsd extended DocumentStatus InvoiceDocumentStatus-test-bad-data-3.xml
call validate   ..\ubl\xsd\maindoc\UBL-DocumentStatus-2.3.xsd extended DocumentStatus InvoiceDocumentStatus-test-good.xml
