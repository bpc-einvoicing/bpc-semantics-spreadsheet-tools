...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <rdf:Description xmlns:dct="http://purl.org/dc/terms/"
      ...
      <dct:created>2022-01-28T15:20:14.048-05:00</dct:created>
   </rdf:Description>
   ...
   <xsl:template match="/CreditNote:CreditNote (:NABT-999 NABT-003 NABT-005 NABT-011 NABT-012 NABT-013 NABT-022 NABG-014 NABT-023 NABT-024 NABG-005 NABG-007 NABT-090 NABG-023 Row 2 7 9 12 13 14 30 32 38 41 58 106 157 194 Tab 'Invoice, Credit Note':)"
                 priority="49"
                 mode="d14e18">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd14e45']">
            <schxslt:rule pattern="d14e45">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "/CreditNote:CreditNote (:NABT-999 NABT-003 NABT-005 NABT-011 NABT-012 NABT-013 NABT-022 NABG-014 NABT-023 NABT-024 NABG-005 NABG-007 NABT-090 NABG-023 Row 2 7 9 12 13 14 30 32 38 41 58 106 157 194 Tab 'Invoice, Credit Note':)" shadowed by preceding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
                  <xsl:attribute name="context">/CreditNote:CreditNote (:NABT-999 NABT-003 NABT-005 NABT-011 NABT-012 NABT-013 NABT-022 NABG-014 NABT-023 NABT-024 NABG-005 NABG-007 NABT-090 NABG-023 Row 2 7 9 12 13 14 30 32 38 41 58 106 157 194 Tab 'Invoice, Credit Note':)</xsl:attribute>
               </svrl:suppressed-rule>
            </schxslt:rule>
            <xsl:next-match>
               <xsl:with-param name="schxslt:patterns-matched"
         ...
         <xsl:otherwise>
            <schxslt:rule pattern="d14e45">
               ...
               <xsl:if test="not(normalize-space(cbc:CustomizationID) = 'urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2::CreditNote##bpc-0.4-data-Core' (:NABT-024 Row 41 Tab 'Invoice, Credit Note':))">
                  <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                      location="{schxslt:location(.)}">
                     <xsl:attribute name="test">normalize-space(cbc:CustomizationID) = 'urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2::CreditNote##bpc-0.4-data-Core' (:NABT-024 Row 41 Tab 'Invoice, Credit Note':)</xsl:attribute>
   ...
   <xsl:template match="cac:CreditNoteLine (:NABT-129 NABG-990 NABG-026 NABG-029 Row 224 246 253 270 Tab 'Invoice, Credit Note':)"
                 priority="9"
                 mode="d14e18">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd14e45']">
            <schxslt:rule pattern="d14e45">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "cac:CreditNoteLine (:NABT-129 NABG-990 NABG-026 NABG-029 Row 224 246 253 270 Tab 'Invoice, Credit Note':)" shadowed by preceding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
                  <xsl:attribute name="context">cac:CreditNoteLine (:NABT-129 NABG-990 NABG-026 NABG-029 Row 224 246 253 270 Tab 'Invoice, Credit Note':)</xsl:attribute>
               </svrl:suppressed-rule>
            </schxslt:rule>
            <xsl:next-match>
               <xsl:with-param name="schxslt:patterns-matched"
   ...
   <xsl:template match="cac:CreditNoteLine/cac:Price/cac:AllowanceCharge (:NABT-148 Row 275 Tab 'Invoice, Credit Note':)"
                 priority="3"
                 mode="d14e18">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd14e45']">
            <schxslt:rule pattern="d14e45">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "cac:CreditNoteLine/cac:Price/cac:AllowanceCharge (:NABT-148 Row 275 Tab 'Invoice, Credit Note':)" shadowed by preceding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
                  <xsl:attribute name="context">cac:CreditNoteLine/cac:Price/cac:AllowanceCharge (:NABT-148 Row 275 Tab 'Invoice, Credit Note':)</xsl:attribute>
               </svrl:suppressed-rule>
            </schxslt:rule>
            <xsl:next-match>
               <xsl:with-param name="schxslt:patterns-matched"
   ...
   <xsl:template match="cac:CreditNoteLine/cac:Item (:NABT-153 NABT-154 Row 292 293 Tab 'Invoice, Credit Note':)"
                 priority="0"
                 mode="d14e18">
      <xsl:param name="schxslt:patterns-matched" as="xs:string*"/>
      <xsl:choose>
         <xsl:when test="$schxslt:patterns-matched[. = 'd14e45']">
            <schxslt:rule pattern="d14e45">
               <xsl:comment xmlns:svrl="http://purl.oclc.org/dsdl/svrl">WARNING: Rule for context "cac:CreditNoteLine/cac:Item (:NABT-153 NABT-154 Row 292 293 Tab 'Invoice, Credit Note':)" shadowed by preceding rule</xsl:comment>
               <svrl:suppressed-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
                  <xsl:attribute name="context">cac:CreditNoteLine/cac:Item (:NABT-153 NABT-154 Row 292 293 Tab 'Invoice, Credit Note':)</xsl:attribute>
               </svrl:suppressed-rule>
            </schxslt:rule>
            <xsl:next-match>
               <xsl:with-param name="schxslt:patterns-matched"
