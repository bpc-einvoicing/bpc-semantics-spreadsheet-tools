...
UNECE-Rec-20-21
-->
   <rule context="/Invoice:Invoice (:NABT-999 NABT-003 NABT-005 NABT-011 NABT-012 NABT-013 NABT-022 NABG-014 NABT-023 NABT-024 NABG-005 NABG-007 NABT-090 NABG-023 Row 2 7 9 12 13 14 30 32 38 41 58 106 157 194 Tab 'Invoice, Credit Note':)">
      ...
      <assert test="normalize-space(cbc:CustomizationID) = 'urn:oasis:names:specification:ubl:schema:xsd:Invoice-2::Invoice##bpc-0.4-data-Core' (:NABT-024 Row 41 Tab 'Invoice, Credit Note':)">Specification Identifier not specified or value specified is not valid. (:NABT-024 Row 41 Tab 'Invoice, Credit Note':)</assert>
   ...
   <rule context="cac:InvoiceLine (:NABT-129 NABG-990 NABG-026 NABG-029 Row 223 246 253 270 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:InvoiceLine/cac:Price/cac:AllowanceCharge (:NABT-148 Row 275 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:InvoiceLine/cac:Item (:NABT-153 NABT-154 Row 292 293 Tab 'Invoice, Credit Note':)">
