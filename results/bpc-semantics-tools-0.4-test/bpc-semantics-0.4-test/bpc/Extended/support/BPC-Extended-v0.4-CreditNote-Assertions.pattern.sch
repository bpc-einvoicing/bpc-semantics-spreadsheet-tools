...
UNECE-Rec-20-21
-->
   <rule context="/CreditNote:CreditNote (:NABT-999 NABT-003 NABT-005 NABT-011 NABT-012 NABT-013 NABT-015 NABT-022 NABG-014 NABT-023 NABT-989 NABT-024 NABG-005 NABG-007 NABT-090 NABG-023 Row 2 7 9 12 13 14 17 30 32 38 39 42 58 106 157 196 Tab 'Invoice, Credit Note':)">
      ...
      <assert test="normalize-space(cbc:CustomizationID) = 'urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2::CreditNote##bpc-0.4-data-Extended' (:NABT-024 Row 42 Tab 'Invoice, Credit Note':)">Specification Identifier not specified or value specified is not valid. (:NABT-024 Row 42 Tab 'Invoice, Credit Note':)</assert>
   ...
   <rule context="/CreditNote:CreditNote/cbc:TaxCurrencyCode (:NABT-006 Row 10 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/CreditNote:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentStatusCode (:NABT-988 Row 45 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/CreditNote:CreditNote/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode (:NABT-098 NABT-105 Row 168 178 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/CreditNote:CreditNote/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject/@mimeCode (:NABT-125-1 Row 217 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/CreditNote:CreditNote/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject (:NABT-125-2 Row 218 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine (:NABT-129 NABT-132 NABG-990 NABG-026 NABG-029 Row 224 228 247 253 270 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine/cac:Delivery (:NABT-940 Row 234 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine/cac:Delivery/cac:DeliveryLocation/cac:Address (:NABT-930 Row 245 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode (:NABT-140 NABT-145 Row 262 269 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine/cac:Price/cac:AllowanceCharge (:NABT-147 NABT-148 Row 273 275 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine/cac:Price/cbc:BaseQuantity/@unitCode (:NABT-150 Row 278 280 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:InvoiceLine/cac:Price/cbc:BaseQuantity/@unitCode (:NABT-150 Row 279 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory (:NABG-030 Row 286 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme (:NABT-167 Row 290 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine/cac:Item (:NABT-153 NABT-154 NABT-157 NABT-159 Row 292 293 297 301 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine/cac:Item/cac:StandardItemIdentification/cbc:ID (:NABT-157-1 Row 298 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode (:NABT-158-1 Row 300 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine/cac:Item/cac:ItemInstance/cac:LotIdentification (:NABT-915 Row 306 Tab 'Invoice, Credit Note':)">
