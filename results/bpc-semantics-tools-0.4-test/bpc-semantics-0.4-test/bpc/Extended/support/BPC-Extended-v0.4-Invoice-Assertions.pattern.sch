...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron">
  <title>BPC Schematron Expressions for process Extended v0.4 - test from worksheet Invoice, Credit Note</title>


   <!--Generated assertions from spreadsheet worksheet Invoice, Credit Note for customization Extended-->
...
UNECE-Rec-20-21
-->
   <rule context="/Invoice:Invoice (:NABT-999 NABT-003 NABT-005 NABT-011 NABT-012 NABT-013 NABT-015 NABT-022 NABG-014 NABT-023 NABT-989 NABT-024 NABG-005 NABG-007 NABT-090 NABG-023 Row 2 7 9 12 13 14 17 30 32 38 39 42 58 106 157 196 Tab 'Invoice, Credit Note':)">
      ...
      <assert test="normalize-space(cbc:InvoiceTypeCode) = ('380','381') (:NABT-003 Row 7 Tab 'Invoice, Credit Note':)">Invoice Type Code not specified or value specified is not allowed. (:NABT-003 Row 7 Tab 'Invoice, Credit Note':)</assert>
      ...
      <assert test="count(cac:ReceiptDocumentReference/cbc:ID) &lt;= 1 (:NABT-015 Row 17 Tab 'Invoice, Credit Note':)">More than one proof of delivery reference exists. (:NABT-015 Row 17 Tab 'Invoice, Credit Note':)</assert>
      ...
      <assert test="count(cbc:ProfileExecutionID) =1 (:NABT-989 Row 39 Tab 'Invoice, Credit Note':)">Session Identifier is not specified or exists more than once. (:NABT-989 Row 39 Tab 'Invoice, Credit Note':)</assert>
      <assert test="normalize-space(cbc:CustomizationID) = 'urn:oasis:names:specification:ubl:schema:xsd:Invoice-2::Invoice##bpc-0.4-data-Extended' (:NABT-024 Row 42 Tab 'Invoice, Credit Note':)">Specification Identifier not specified or value specified is not valid. (:NABT-024 Row 42 Tab 'Invoice, Credit Note':)</assert>
      ...
      <assert test="if( exists( cbc:TaxCurrencyCode ) ) then count( cac:TaxTotal ) &lt;= 2 else count( cac:TaxTotal ) &lt;= 1 (:NABG-023 Row 196 Tab 'Invoice, Credit Note':)">Too many tax total information items (:NABG-023 Row 196 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="/Invoice:Invoice/cbc:TaxCurrencyCode (:NABT-006 Row 10 Tab 'Invoice, Credit Note':)">
      <assert test="bpc:codelist(.,'ISO-4217') (:NABT-006 Row 10 Tab 'Invoice, Credit Note':)">Tax Currency Code value specified is not allowed. (:NABT-006 Row 10 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   ...
   <rule context="/Invoice:Invoice/cac:InvoicePeriod (:NABT-073 NABT-074 Row 33 35 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:BillingReference/cac:InvoiceDocumentReference (:NABT-025 Row 44 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:BillingReference/cac:InvoiceDocumentReference/cbc:DocumentStatusCode (:NABT-988 Row 45 Tab 'Invoice, Credit Note':)">
      <assert test="bpc:codelist(.,'UNECE-1373') (:NABT-988 Row 45 Tab 'Invoice, Credit Note':)">Value is not found in code list UNECE-1373. (:NABT-988 Row 45 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   ...
   <rule context="/Invoice:Invoice/cac:AccountingSupplierParty/cac:Party (:NABT-030 Row 52 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID (:NABT-030-1 Row 53 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:AccountingSupplierParty/cac:Party/cbc:EndpointID (:NABT-34-1 Row 57 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:PayeeParty (:NABT-59 NABT-60 NABT-61 Row 70 71 73 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:PayeeParty/cac:PartyIdentification/cbc:ID (:NABT-60-1 Row 72 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:PayeeParty/cac:PartyLegalEntity/cbc:CompanyID (:NABT-61-1 Row 74 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:PayeeParty/cac:PostalAddress (:NABT-981 Row 80 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:SellerSupplierParty (:NABT-976 NABT-975 NABT-974 NABT-972 Row 87 88 89 91 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:SellerSupplierParty/cac:Party/cac:PartyIdentification/cbc:ID (:NABT-973 Row 90 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:SellerSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID (:NABT-971 Row 92 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:SellerSupplierParty/cac:Party/cbc:EndpointID (:NABT-969 Row 94 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:SellerSupplierParty/cac:Party/cac:PostalAddress (:NABT-964 Row 100 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:AccountingCustomerParty (:NABT-045 NABT-046 NABT-047 Row 108 109 111 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PartyLegalEntity/cbc:CompanyID (:NABT-047-1 Row 112 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:AccountingCustomerParty/cac:Party/cbc:EndpointID (:NABT-049-1 Row 115 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:Delivery (:NABT-070 Row 129 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:Delivery/cac:DeliveryLocation/cac:Address (:NABT-080 Row 140 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:PaymentMeans (:NABT-081 NABT-083 Row 142 146 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:TaxCategory (:NABT-095 NABT-118 NABT-927 NABT-151 Row 164 200 251 287 Tab 'Invoice, Credit Note':)">
      ...
      <assert test="bpc:codelist(cbc:ID,'UNECE-5305') (:NABT-151 Row 287 Tab 'Invoice, Credit Note':)">Invoiced Item Tax Category Code is not specified or specified value is invalid. (:NABT-151 Row 287 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="/Invoice:Invoice/cac:AllowanceCharge/cac:TaxCategory (:NABT-096 NABT-102 Row 165 174 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:AllowanceCharge/cac:TaxCategory/cac:TaxScheme/cbc:ID (:NABT-952 NABT-950 Row 166 176 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode (:NABT-098 NABT-105 Row 168 178 Tab 'Invoice, Credit Note':)">
      <assert test="bpc:codelist(.,'UNECE-5189') (:NABT-098 Row 168 Tab 'Invoice, Credit Note':)">Document level discount reason code is invalid. (:NABT-098 Row 168 Tab 'Invoice, Credit Note':)</assert>
      <assert test="bpc:codelist(.,'UNECE-5189') (:NABT-105 Row 178 Tab 'Invoice, Credit Note':)">Document level charge reason code is not a valid value from UNECE-5189 code list. (:NABT-105 Row 178 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   ...
   <rule context="cac:TaxTotal[1]/cbc:TaxAmount (:NABT-111 Row 186 Tab 'Invoice, Credit Note':)">
      <assert test="@currencyID = /*/cbc:DocumentCurrencyCode (:NABT-111 Row 186 Tab 'Invoice, Credit Note':)">The first tax total is not in the document currency. (:NABT-111 Row 186 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="cac:TaxTotal[2]/cbc:TaxAmount (:NABT-111 Row 187 Tab 'Invoice, Credit Note':)">
      <assert test="@currencyID = /*/cbc:TaxCurrencyCode (:NABT-111 Row 187 Tab 'Invoice, Credit Note':)">The second tax total is not in the tax currency. (:NABT-111 Row 187 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   ...
   <rule context="cac:TaxTotal[2] (:NABG-023 Row 197 Tab 'Invoice, Credit Note':)">
      <assert test="count( cac:TaxSubtotal ) = 0 (:NABG-023 Row 197 Tab 'Invoice, Credit Note':)">The second tax total incorrectly has breakdown information. (:NABG-023 Row 197 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="/Invoice:Invoice/cac:TaxTotal/cac:TaxSubtotal (:NABT-116 NABT-120 Row 198 202 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/Invoice:Invoice/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject/@mimeCode (:NABT-125-1 Row 217 Tab 'Invoice, Credit Note':)">
      <assert test="bpc:codelist(.,'IANA-Media-Types') (:NABT-125-1 Row 217 Tab 'Invoice, Credit Note':)">Embedded binary object MIME code is not valid. (:NABT-125-1 Row 217 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="/Invoice:Invoice/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject (:NABT-125-2 Row 218 Tab 'Invoice, Credit Note':)">
      <assert test="count (@filename ) = 1 (:NABT-125-2 Row 218 Tab 'Invoice, Credit Note':)">Attached document filename is not specified. (:NABT-125-2 Row 218 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="cac:InvoiceLine/cbc.Note (:NABT-127 Row 221 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:InvoiceLine (:NABT-129 NABT-132 NABG-990 NABG-026 NABG-029 Row 223 228 247 253 270 Tab 'Invoice, Credit Note':)">
      ...
      <assert test="count (cac:OrderLineReference/cbc:LineID) =1 (:NABT-132 Row 228 Tab 'Invoice, Credit Note':)">Purchase Order Line Number is not specified or exists more than once. (:NABT-132 Row 228 Tab 'Invoice, Credit Note':)</assert>
      <assert test="if( exists( /*/cbc:TaxCurrencyCode ) ) then count( cac:TaxTotal ) &lt;= 2 else count( cac:TaxTotal ) &lt;= 1 (:NABG-990 Row 247 Tab 'Invoice, Credit Note':)">Too many tax total information items (:NABG-990 Row 247 Tab 'Invoice, Credit Note':)</assert>
   ...
   <rule context="cac:InvoiceLine/cac:Delivery (:NABT-940 Row 234 Tab 'Invoice, Credit Note':)">
      <assert test="count (cac:DeliveryParty/cac:PartyName/cbc:Name) &lt;= 1 (:NABT-940 Row 234 Tab 'Invoice, Credit Note':)">More than one Document Line Deliver to party name exists. (:NABT-940 Row 234 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="cac:InvoiceLine/cac:Delivery/cac:DeliveryLocation/cac:Address (:NABT-930 Row 245 Tab 'Invoice, Credit Note':)">
      <assert test="bpc:codelist(cac:Country/cbc:IdentificationCode,'ISO-3166') (:NABT-930 Row 245 Tab 'Invoice, Credit Note':)">Document Line Deliver to Country Code is invalid. (:NABT-930 Row 245 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="cac:InvoiceLine/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID (:NABT-926 Row 252 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:InvoiceLine/cac:InvoicePeriod (:NABT-134 NABT-135 Row 254 255 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:InvoiceLine/cac:AllowanceCharge (:NABT-139 NABT-144 Row 261 268 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:InvoiceLine/cac:AllowanceCharge/cbc:AllowanceChargeReasonCode (:NABT-140 NABT-145 Row 262 269 Tab 'Invoice, Credit Note':)">
      <assert test="bpc:codelist(.,'UNECE-5189') (:NABT-140 Row 262 Tab 'Invoice, Credit Note':)">Invoice line discount reason code is invalid. (:NABT-140 Row 262 Tab 'Invoice, Credit Note':)</assert>
      <assert test="bpc:codelist(.,'UNECE-5189') (:NABT-145 Row 269 Tab 'Invoice, Credit Note':)">Invoice line charge reason code is invalid. (:NABT-145 Row 269 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="cac:InvoiceLine/cac:Price/cac:AllowanceCharge (:NABT-147 NABT-148 Row 273 275 Tab 'Invoice, Credit Note':)">
      <assert test="count (cbc:Amount) &lt;= 1 (:NABT-147 Row 273 Tab 'Invoice, Credit Note':)">More than one item price discount exists. (:NABT-147 Row 273 Tab 'Invoice, Credit Note':)</assert>
   ...
   <rule context="cac:InvoiceLine/cac:Price/cac:AllowanceCharge/cbc:BaseAmount (:NABT-148 Row 276 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:InvoiceLine/cac:Price/cbc:BaseQuantity/@unitCode (:NABT-150 Row 278 279 Tab 'Invoice, Credit Note':)">
      <assert test="bpc:codelist(.,'UNECE-Rec-20-21') (:NABT-150 Row 278 Tab 'Invoice, Credit Note':)">Item Price Base Quantity Unit of Measure Code is not a valid value from UN/ECE Recommendation N. 20 code list or UN/ECE Recommendation N. 21 (with the prefix 'X' on each) code list. (:NABT-150 Row 278 Tab 'Invoice, Credit Note':)</assert>
      <assert test=". = ../../cbc:InvoicedQuantity/@unitCode (:NABT-150 Row 279 Tab 'Invoice, Credit Note':)">Item Price Base Quantity Unit of Measure Code does not equal Invoiced Quantity Unit of Measure Code. (:NABT-150 Row 279 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="cac:CreditNoteLine/cac:Price/cbc:BaseQuantity/@unitCode (:NABT-150 Row 280 Tab 'Invoice, Credit Note':)">
      <assert test=". = ../../cbc:CreditedQuantity/@unitCode (:NABT-150 Row 280 Tab 'Invoice, Credit Note':)">Item Price Base Quantity Unit of Measure Code does not equal Credited Quantity Unit of Measure Code. (:NABT-150 Row 280 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   ...
   <rule context="cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory (:NABG-030 Row 286 Tab 'Invoice, Credit Note':)">
      <assert test="if( count(cbc:Percent) = 1 and count(cbc:PerUnitAmount) = 1 ) then false() else true() (:NABG-030 Row 286 Tab 'Invoice, Credit Note':)">Invoiced Item Tax Rate and Per Unit Tax Amount are mutually exclusive. (:NABG-030 Row 286 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="cac:InvoiceLine/cac:Item/cac:ClassifiedTaxCategory/cac:TaxScheme (:NABT-167 Row 290 Tab 'Invoice, Credit Note':)">
      <assert test="bpc:codelist(cbc:ID,'UNECE-5153') (:NABT-167 Row 290 Tab 'Invoice, Credit Note':)">Invoiced Item Tax Scheme Identifier value specified is not valid. (:NABT-167 Row 290 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="cac:InvoiceLine/cac:Item (:NABT-153 NABT-154 NABT-157 NABT-159 Row 292 293 297 301 Tab 'Invoice, Credit Note':)">
      ...
      <assert test="count (cac:StandardItemIdentification/cbc:ID) = 1 or count (cbc:Description) = 1 (:NABT-157 Row 297 Tab 'Invoice, Credit Note':)">Both the standard identification number and description are missing. (:NABT-157 Row 297 Tab 'Invoice, Credit Note':)</assert>
      <assert test="bpc:codelist(cac:OriginCountry/cbc:IdentificationCode,'ISO-3166') (:NABT-159 Row 301 Tab 'Invoice, Credit Note':)">Item country of origin code is not a valid value from International Organization for Standardization (ISO) ISO 3166-Country Codes. (:NABT-159 Row 301 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="cac:InvoiceLine/cac:Item/cac:StandardItemIdentification/cbc:ID (:NABT-157-1 Row 298 Tab 'Invoice, Credit Note':)">
      <assert test="count (@schemeID ) = 1 (:NABT-157-1 Row 298 Tab 'Invoice, Credit Note':)">Scheme Identifier does not exist when Product/Service Code is provided. (:NABT-157-1 Row 298 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="cac:InvoiceLine/cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode (:NABT-158-1 Row 300 Tab 'Invoice, Credit Note':)">
      <assert test="count (@listID ) = 1 (:NABT-158-1 Row 300 Tab 'Invoice, Credit Note':)">Scheme Identifier does not exist when Item Classification Identifier is provided. (:NABT-158-1 Row 300 Tab 'Invoice, Credit Note':)</assert>
   </rule>
   <rule context="cac:InvoiceLine/cac:Item/cac:ItemInstance/cac:LotIdentification (:NABT-915 Row 306 Tab 'Invoice, Credit Note':)">
      <assert test="count (cbc:LotNumberID) = 1 (:NABT-915 Row 306 Tab 'Invoice, Credit Note':)">Lot identification number is not specified or exists more than once. (:NABT-915 Row 306 Tab 'Invoice, Credit Note':)</assert>
   </rule>
</pattern>
