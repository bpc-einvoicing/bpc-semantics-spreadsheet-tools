...
UNECE-Rec-20-21
-->
   <rule context="/CreditNote:CreditNote (:NABT-999 NABT-005 NABT-013 NABT-022 NABT-023 NABT-024 NABG-005 NABG-007 NABG-023 Row 2 9 14 30 38 40 58 106 194 Tab 'Invoice, Credit Note':)">
      ...
      <assert test="normalize-space(cbc:CustomizationID) = 'urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2::CreditNote##bpc-0.4-data-Minimum' (:NABT-024 Row 40 Tab 'Invoice, Credit Note':)">Specification Identifier not specified or value specified is not valid. (:NABT-024 Row 40 Tab 'Invoice, Credit Note':)</assert>
   ...
   <rule context="/CreditNote:CreditNote/cac:AccountingCustomerParty (:NABT-045 NABT-046 Row 108 109 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/CreditNote:CreditNote/cac:PaymentMeans (:NABT-081 Row 142 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/CreditNote:CreditNote/cac:AllowanceCharge/cac:TaxCategory (:NABT-102 Row 174 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="/CreditNote:CreditNote/cac:AllowanceCharge/cac:TaxCategory/cac:TaxScheme/cbc:ID (:NABT-950 Row 176 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine (:NABT-129 NABG-029 Row 224 270 Tab 'Invoice, Credit Note':)">
   ...
   <rule context="cac:CreditNoteLine/cac:Item (:NABT-153 Row 292 Tab 'Invoice, Credit Note':)">
